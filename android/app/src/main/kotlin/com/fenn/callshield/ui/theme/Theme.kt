...
private val DarkColorScheme = darkColorScheme(
    ...
    onSecondary = Color(0xFF220060),
    secondaryContainer = Color(0xFF3D1A80),
    onSecondaryContainer = Color(0xFFDAC8FF),
    ...
    surfaceTint = Color(0xFF4D9EFF),
    surfaceBright = Color(0xFF1C2438),
    surfaceDim = Color(0xFF0A0F1E),
    surfaceContainer = Color(0xFF141929),
    surfaceContainerLow = Color(0xFF111626),
    surfaceContainerHigh = Color(0xFF1A2035),
    surfaceContainerHighest = Color(0xFF1C2438),
...
private val LightColorScheme = lightColorScheme(
    ...
    surfaceDim = Color(0xFFDDE3F4),
    surfaceContainer = Color(0xFFEEF2FF),
    surfaceContainerLow = Color(0xFFF5F7FF),
    surfaceContainerHigh = Color(0xFFE6ECFF),
    surfaceContainerHighest = Color(0xFFDDE3F8),
